...
const testExplicitCookie = async () => {
  try {
    console.log('🧪 Testing explicit cookie inclusion...');
    ...
    // Step 2: Test signup with explicit cookie header
    console.log('📡 Step 2: Testing signup with explicit cookie...');
