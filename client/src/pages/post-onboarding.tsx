    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-slate-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Your payment was successful. Please verify your email to activate your account.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-center text-gray-600">
            We sent a verification link to your email. Click the link to finish activation.
          </p>
          <div className="flex flex-col space-y-2">
            <Button onClick={() => setLocation('/login')} className="w-full">Back to Login</Button>
